...
signal inventory_change(panel, held_item)
...
func _on_InventoryBar_inventory_change(panel, held_item)->void:
	emit_signal("inventory_changed", panel, held_item)


func _on_InventoryBar_inventory_changed(panel, held_item):
